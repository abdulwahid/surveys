...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Update Survey Type "{{ $surveyType->name }}"</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="{{ route('admin-survey-types-post-update', $surveyType->id) }}" method="post">

                            <div class="form-group {{ ($errors && $errors->has('name')) ? 'has-error' : '' }}">
                                <label>Name</label>
                                <input name="name" class="form-control" value="{{ (old('name')) ? old('name') : $surveyType->name }}">
                            ...
                            <div class="form-group {{ ($errors && $errors->has('description')) ? 'has-error' : '' }}">
                                ...
                                <input name="description" class="form-control" value="{{ (old('description')) ? old('description') : $surveyType->description }}">
